...
const EmailSending = () => {
    ...
    const emailsending = async (details) => {
        ...
        try {
            ...
            const deleteresponse = await fetch("https://url-shortner-backend-itr5.onrender.com/activate/delete", {
                method: "DELETE",
            ...
            if (deleteData.message === "Successfully URL token deleted") {
                ...
                const emailresponse = await fetch("https://url-shortner-backend-itr5.onrender.com/activate", {
                    method: "POST",
                    body: JSON.stringify(details),
                    headers: {
    ...
    useEffect(() => {
        const validation = async () => {
            ...
            try {
                ...
                const response = await fetch(`https://url-shortner-backend-itr5.onrender.com/verify/${params.id}`, {
                    method: "PUT",
                    body: JSON.stringify(),
                    headers: {
                        "Content-Type": "application/json"
